            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: Slider(
                  ...
                  onChanged: (value) => provider.setKeyHeight(value),
                ),
                trailing: Text(
              ...
              ListTile(
                ...
                subtitle: Slider(
                  ...
                  onChanged: (value) => provider.setKeySpacing(value),
                ),
                trailing: Text(
              ...
              SwitchListTile(
                ...
                onChanged: (value) => provider.setShowNumberRow(value),
              ),
              ...
              SwitchListTile(
                ...
                onChanged: (value) => provider.setShowPreview(value),
              ),
              ...
              ListTile(
                ...
                trailing: DropdownButton<int>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 2, child: Text('𑴎𑴟𑴤𑴦')),
                  ],
                  onChanged: (value) {
                    if (value != null) provider.setDefaultLanguage(value);
                  },
                ),
              ),
              ...
              SwitchListTile(
                ...
                onChanged: (value) => provider.setSoundOnKeyPress(value),
              ),
              ...
              SwitchListTile(
                ...
                onChanged: (value) => provider.setShowSuggestions(value),
              ),
              ...
              if (settings.showSuggestions)
                ListTile(
                  ...
                  trailing: DropdownButton<int>(
                    ...
                    onChanged: (value) {
                      if (value != null) provider.setSuggestionCount(value);
                    },
                  ),
                ),
              ...
              ListTile(
                ...
                subtitle: Text('${provider.customWordsCount} custom words'),
                trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                onTap: () {
                  Navigator.push(
                    context,
              ...
              SwitchListTile(
                ...
                onChanged: (value) => provider.setAutoCapitalize(value),
              ),
              ...
              SwitchListTile(
                ...
                subtitle: const Text(
                  'Swipe left on backspace to delete faster',
                ),
                value: settings.swipeToDelete,
                onChanged: (value) => provider.setSwipeToDelete(value),
              ),
              ...
              SwitchListTile(
                ...
                subtitle: const Text(
                  'Hold keys to access alternate characters',
                ),
                value: settings.longPressForSymbols,
                onChanged: (value) => provider.setLongPressForSymbols(value),
              ),
              ...
              SwitchListTile(
                ...
                onChanged: (value) => provider.setEnableGlideTyping(value),
              ),
